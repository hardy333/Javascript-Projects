...
var state = {
    ...
    // page is ricxvi  igivea rac button is rigiti nomeri [1, ..] range
    page: 1,
    // tito page ze row ebis raodenoba 
    rows: 5,
    


    // maximum ramdeni button gamochndeba , sheidzleba naklebi gamochndes amaze tu pages raodenoba naklebia window -ze 
    window: 5, 
